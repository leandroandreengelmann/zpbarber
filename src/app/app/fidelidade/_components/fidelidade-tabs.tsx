...
const TABS = [
  { href: "/app/fidelidade", label: "Visão geral", exact: true },
  { href: "/app/fidelidade/recompensas", label: "Recompensas", gestorOnly: true },
  { href: "/app/fidelidade/configuracoes", label: "Configurações", gestorOnly: true },
];

export function FidelidadeTabs({ isGestor }: { isGestor: boolean }) {

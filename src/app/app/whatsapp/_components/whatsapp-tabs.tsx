...
const TABS = [
  { href: "/app/whatsapp", label: "Visão geral", exact: true },
  { href: "/app/whatsapp/templates", label: "Templates", gestorOnly: true },
  { href: "/app/whatsapp/configuracoes", label: "Configurações", gestorOnly: true },
];

export function WhatsappTabs({ isGestor }: { isGestor: boolean }) {
